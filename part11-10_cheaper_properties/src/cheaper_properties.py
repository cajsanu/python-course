...
def cheaper_properties(properties: list, reference: RealProperty):
    return [(property, property.price_difference(reference)) for property in properties if not property.more_expensive(reference) and property.description != reference.description]
